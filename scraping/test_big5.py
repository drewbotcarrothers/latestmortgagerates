"""
Test all Big 5 bank scrapers with live captured rates.
...
def scrape_all_banks():
    """Scrape all Big 5 banks and save to database."""
    
    logger.info("Starting Big 5 bank scraping pipeline")
    ...
    print("\n" + "="*70)
    print("SCRAPING BIG 5 BANK RATES")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("BIG 5 RATE COMPARISON (5-Year Fixed, Uninsured)")
    print("="*70)
    ...
    # Show variable rates
    print("\n" + "="*70)
    print("BIG 5 RATE COMPARISON (5-Year Variable, Uninsured)")
    print("="*70)
    ...
    for r in sorted_var:
        ...
        print(f"  {r.lender_name:20} {r.rate}%{posted_str}{apr_str}")
    ...
    print("\n" + "="*70)
    print(f"PIPELINE COMPLETE: {success_count}/{len(scrapers)} banks scraped successfully")
