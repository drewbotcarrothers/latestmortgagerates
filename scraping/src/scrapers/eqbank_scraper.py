...
class EQBankScraper:
    ...
    def scrape(self) -> List[RawRate]:
        ...
        logger.info("Using fallback rates from EQ Bank (Apr 25, 2026)")
                        ...
                        try:
                            ...
                            if 1 <= years <= 10 and 2 <= rate <= 10:
                                rates.append(RawRate(
                                    ...
                                    raw_data={"source": "eqbank_live_scrape", "years": years}
                                ))
                        except:
                            pass
    ...
    def _get_fallback_rates(self) -> List[RawRate]:
        """
        Fallback rates from EQ Bank (April 25, 2026).
        EQ Bank is competitive with other digital banks.
        """
        logger.info("Using fallback rates from EQ Bank (Apr 25, 2026)")
        ...
        fallback_data = [
            ...
            {"term": 60, "type": RateType.FIXED, "rate": "4.19", "mortgage_type": "insured", "product": "5 Year Fixed (Insured)"},
            {"term": 60, "type": RateType.VARIABLE, "rate": "4.20", "mortgage_type": "uninsured", "product": "5 Year Variable"},
            {"term": 60, "type": RateType.VARIABLE, "rate": "4.00", "mortgage_type": "insured", "product": "5 Year Variable (Insured)"},
        ]
        ...
        for item in fallback_data:
            ...
            raw_data = {
                "source": "eqbank_fallback_2026-04-25",
