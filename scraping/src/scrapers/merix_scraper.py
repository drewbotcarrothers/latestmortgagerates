...
class MerixScraper:
    ...
    def scrape(self) -> List[RawRate]:
        ...
        logger.info("Using fallback rates from Merix Financial (2026-07-19)")
    ...
    def _get_fallback_rates(self) -> List[RawRate]:
        ...
        fallback_data = [
            ...
            {"term": 24, "type": RateType.FIXED, "rate": "4.74", "mortgage_type": "uninsured", "product": "2 Year Fixed"},
            {"term": 36, "type": RateType.FIXED, "rate": "4.34", "mortgage_type": "uninsured", "product": "3 Year Fixed", "featured": True},
            {"term": 48, "type": RateType.FIXED, "rate": "4.19", "mortgage_type": "uninsured", "product": "4 Year Fixed"},
            ...
            {"term": 84, "type": RateType.FIXED, "rate": "4.14", "mortgage_type": "uninsured", "product": "7 Year Fixed"},
        ...
        for item in fallback_data:
            ...
            raw_data = {
                "source": "merix_fallback_2026-07-19",
