...
class MerixScraper:
    ...
    def scrape(self) -> List[RawRate]:
        ...
        try:
            ...
            if rates:
                logger.success(f"Successfully scraped {len(rates)} live rates from Merix Financial")
                return rates
        except Exception as e:
            logger.warning(f"Playwright scraping failed: {e}")
        
        logger.info("Using fallback rates from Merix Financial (Apr 25, 2026)")
                        ...
                        try:
                            ...
                            if 1 <= years <= 10 and 2 <= rate <= 10:
                                rates.append(RawRate(
                                    ...
                                    raw_data={"source": "merix_live_scrape", "years": years}
                                ))
                        except:
                            pass
    ...
    def _get_fallback_rates(self) -> List[RawRate]:
        """
        Fallback rates from Merix Financial (April 25, 2026).
        Merix is very competitive on fixed rates.
        """
        logger.info("Using fallback rates from Merix Financial (Apr 25, 2026)")
        
        fallback_data = [
            {"term": 12, "type": RateType.FIXED, "rate": "5.54", "mortgage_type": "uninsured", "product": "1 Year Fixed"},
            {"term": 24, "type": RateType.FIXED, "rate": "5.24", "mortgage_type": "uninsured", "product": "2 Year Fixed"},
            ...
            {"term": 84, "type": RateType.FIXED, "rate": "4.64", "mortgage_type": "uninsured", "product": "7 Year Fixed"},
        ...
        for item in fallback_data:
            ...
            raw_data = {
                "source": "merix_fallback_2026-04-25",
