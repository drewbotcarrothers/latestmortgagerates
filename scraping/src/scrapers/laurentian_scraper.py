...
class LaurentianBankScraper:
    ...
    def scrape(self) -> List[RawRate]:
        ...
        logger.info("Using fallback rates from Laurentian Bank (Apr 25, 2026)")
    ...
    def _get_fallback_rates(self) -> List[RawRate]:
        ...
        fallback_data = [
            ...
            {"term": 36, "type": RateType.FIXED, "rate": "5.39", "mortgage_type": "uninsured", "product": "3 Year Fixed", "featured": True},
            {"term": 48, "type": RateType.FIXED, "rate": "5.39", "mortgage_type": "uninsured", "product": "4 Year Fixed"},
            {"term": 60, "type": RateType.FIXED, "rate": "5.39", "mortgage_type": "uninsured", "product": "5 Year Fixed", "featured": True},
            {"term": 60, "type": RateType.FIXED, "rate": "5.24", "mortgage_type": "insured", "product": "5 Year Fixed (Insured)"},
            {"term": 60, "type": RateType.VARIABLE, "rate": "4.85", "mortgage_type": "uninsured", "product": "5 Year Variable"},
            {"term": 60, "type": RateType.VARIABLE, "rate": "4.65", "mortgage_type": "insured", "product": "5 Year Variable (Insured)"},
        ]
        ...
        for item in fallback_data:
            ...
            raw_data = {
                "source": "laurentian_fallback_2026-04-25",
