...
Centum is Canada's largest mortgage brokerage network.
"""
...
class CentumScraper:
    ...
    def scrape(self) -> List[RawRate]:
        ...
        logger.success(f"Successfully scraped {len(rates)} rates from Centum")
        return rates
    
    def _get_fallback_rates(self) -> List[RawRate]:
        """
        Fallback rates based on Centum typical broker rates.
        """
        logger.info("Using fallback rates for Centum")
