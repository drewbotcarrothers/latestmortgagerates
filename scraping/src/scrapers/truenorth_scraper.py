    ...
    def _scrape_with_playwright(self) -> List[RawRate]:
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                page.goto(self.PROVINCE_URLS["ontario"], wait_until="domcontentloaded", timeout=30000)
                ...
                page.goto(self.PROVINCE_URLS["alberta"], wait_until="domcontentloaded", timeout=30000)
