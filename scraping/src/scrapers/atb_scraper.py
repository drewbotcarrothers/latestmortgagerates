...
class ATBScraper:
    ...
    def scrape(self) -> List[RawRate]:
        ...
        logger.info("Using fallback rates from ATB Financial (Apr 25, 2026)")
    ...
    def _get_fallback_rates(self) -> List[RawRate]:
        ...
        fallback_data = [
            ...
            {"term": 48, "type": RateType.FIXED, "rate": "4.84", "mortgage_type": "uninsured", "product": "4 Year Fixed"},
        ...
        for item in fallback_data:
            ...
            raw_data = {
                "source": "atb_fallback_2026-04-25",
