...
class MotiveScraper:
    ...
    def scrape(self) -> List[RawRate]:
        ...
        logger.info("Using fallback rates from Motive Financial (Apr 25, 2026)")
    ...
    def _get_fallback_rates(self) -> List[RawRate]:
        ...
        fallback_data = [
            {"term": 12, "type": RateType.FIXED, "rate": "6.09", "mortgage_type": "uninsured", "product": "1 Year Fixed"},
        ...
        for item in fallback_data:
            ...
            raw_data = {
                "source": "motive_fallback_2026-04-25",
