...
class StreetCapitalScraper:
    ...
    def scrape(self) -> List[RawRate]:
        ...
        logger.warning("Street Capital live scraping failed - returning empty list")
        return []
    
    def _scrape_with_playwright(self) -> List[RawRate]:
        """Use Playwright to scrape live rates from Street Capital tables."""
        try:
            ...
            with sync_playwright() as p:
                ...
                # Navigate to Street Capital mortgage rates page
                page.goto(self.RATE_URL, wait_until="domcontentloaded", timeout=30000)
                page.wait_for_timeout(3000)
                
                rates = []
                
                # Street Capital may have tables with mortgage rates
                tables = page.query_selector_all("table")
                logger.info(f"Found {len(tables)} tables on Street Capital page")
                ...
                for table in tables:
                    ...
                    for row in rows:
                        ...
                        rates.append(RawRate(
                            ...
                            raw_data={
                                "source": "streetcapital_live_scrape",
                                "term_text": term_text,
                                "rate_text": rate_text,
