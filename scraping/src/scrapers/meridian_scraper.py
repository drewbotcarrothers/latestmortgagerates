...
class MeridianScraper:
    ...
    def scrape(self) -> List[RawRate]:
        """Scrape Meridian Credit Union mortgage rates."""
        ...
        logger.warning("Meridian live scraping failed - returning empty list")
        return []
    
    def _scrape_with_playwright(self) -> List[RawRate]:
        """Use Playwright to scrape live rates from Meridian tables."""
        try:
            ...
            with sync_playwright() as p:
                ...
                # Navigate to Meridian mortgage rates page
                page.goto(self.RATE_URL, wait_until="domcontentloaded", timeout=30000)
                page.wait_for_timeout(3000)
                
                rates = []
                
                # Meridian has tables with fixed and variable mortgage rates
                tables = page.query_selector_all("table")
                logger.info(f"Found {len(tables)} tables on Meridian page")
                ...
                for table in tables:
                    ...
                    is_high_ratio = "high ratio" in header_text
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"\nScraped {len(rates)} rates from Meridian Credit Union:")
        print("-" * 60)
