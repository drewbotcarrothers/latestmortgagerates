          ...
          <aside className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mt-6">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/cities/waterloo" className="text-teal-600 hover:underline">Compare: Waterloo</a></li>
                <li><a href="/cities/kitchener" className="text-teal-600 hover:underline">Compare: Kitchener</a></li>
              </ul>
            </div>
