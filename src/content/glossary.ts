...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    definition: "Lenders use two ratios to determine how much you can borrow: GDS (Gross Debt Service) which includes housing costs (max 39% of income) and TDS (Total Debt Service) which includes all debts (max 44% of income).",
  },
  {
    term: "Down Payment",
    slug: "down-payment",
  ...
  },
  {
    ...
    slug: "gds-ratio",
    category: "Qualification",
    definition: "The percentage of your gross monthly income that covers housing costs (mortgage payment, property taxes, heating, and 50% of condo fees). Maximum GDS is 39% for qualification purposes.",
  },
  {
  ...
  },
  {
    ...
    category: "Programs",
    definition: "A program allowing first-time buyers to withdraw up to $60,000 ($120,000 for couples) from their RRSP to buy a home. The amount must be repaid over 15 years, starting the second year after withdrawal.",
  },
  {
  ...
  },
  {
    ...
    slug: "tds-ratio",
    category: "Qualification",
    definition: "The percentage of your gross monthly income needed to cover all housing costs (GDS) plus all other debt payments (car loans, credit cards, student loans). Maximum TDS is 44% for qualification.",
  },
  {
...
// Attach related tools to terms
export const glossaryTermsWithTools: GlossaryTerm[] = glossaryTerms.map((term) => ({
  ...term,
  relatedTools: relatedToolsMap[term.slug],
}));
