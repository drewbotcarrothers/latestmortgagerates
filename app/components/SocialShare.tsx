  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <button
        ...
        className="p-2 bg-black hover:bg-gray-800 text-white rounded-full transition"
      ...
      <button
        ...
        className="p-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-full transition relative"
        title="Copy link"
