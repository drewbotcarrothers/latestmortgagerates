    ...
    <main className="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <nav className="text-sm text-gray-500 dark:text-gray-400 mb-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              ...
              <li className="text-gray-900 dark:text-white font-medium">Terms of Service</li>
            </ol>
          </nav>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <article className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Disclaimer: Not Financial Advice</h2>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">By using this Website, you agree to:</p>
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Third-Party Content and Links</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">If you have questions about these Terms of Service, please contact us:</p>
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
              <p className="text-gray-700 dark:text-gray-300">Email:{' '}
                <a href="mailto:legal@latestmortgagerates.ca" className="text-blue-600 dark:text-blue-400 hover:underline">
      ...
      {/* Footer */}
      <footer className="max-w-7xl mx-auto px-4 py-8 mt-8 border-t border-gray-200 dark:border-gray-700">
