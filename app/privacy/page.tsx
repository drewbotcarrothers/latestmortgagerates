  ...
  return (
    <main className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <article className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 prose dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mt-4 mb-2">Personal Information</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              ...
              <a href="mailto:privacy@latestmortgagerates.ca" className="text-blue-600 hover:underline">
