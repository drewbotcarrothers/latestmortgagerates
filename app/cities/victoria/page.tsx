        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <nav className="text-sm text-slate-500 mb-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              ...
              <li className="text-slate-900 font-medium">Victoria</li>
            </ol>
          </nav>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-slate-900">Best Mortgage Rates in Victoria 2025</h1>
              <p className="text-slate-600 mt-2 text-lg">BC's capital without Vancouver prices. Mild climate, ocean views. Find your rate.</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Current Victoria Mortgage Rates</h2>
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-semibold text-slate-900">BC First Time Home Buyers' Program</h3>
                  <p className="text-slate-700">Property Transfer Tax exemption on homes up to $500K. Partial exemption up to $835K.</p>
                </div>                
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-slate-900">BC Home Owner Mortgage Program</h3>
                  <p className="text-slate-700">First-time buyers in Victoria may qualify for property tax deferment.</p>
                </div>
              </div>
            </section>

            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Victoria Market Factors</h2>
              
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-semibold text-slate-900">No Speculation Tax</h3>
                  <p className="text-slate-700">Victoria is exempt from BC's Speculation and Vacancy Tax. 
                  Unlike Vancouver, there's no annual tax on vacant or foreign-owned properties.</p>
                </div>
                
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-slate-900">Government Employment</h3>
                  <p className="text-slate-700">Provincial capital with major BC government presence. 
                  Stable employment base unlike resource-dependent cities.</p>
                </div>
                
                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="font-semibold text-slate-900">Mediterranean Climate</h3>
                  <p className="text-slate-700">Canada's most mild climate - warm summers, minimal snow in winter. 
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
              <h3 className="font-bold text-slate-900 mb-4">Why Victoria?</h3>
              
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500">✓</span>
                  <span className="text-slate-700">50% cheaper than Vancouver</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500">✓</span>
                  <span className="text-slate-700">No speculation tax</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500">✓</span>
                  <span className="text-slate-700">Warmest climate in Canada</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500">✓</span>
                  <span className="text-slate-700">Island lifestyle</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mt-6">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/cities/kelowna" className="text-teal-600 hover:underline">Kelowna Rates</Link></li>
            ...
            <div className="bg-teal-50 rounded-lg p-6 mt-6">
              <h3 className="font-bold text-slate-900 mb-2">Compare Victoria Rates</h3>
              <p className="text-slate-600 text-sm mb-4">See rates from Vancouver Island lenders.</p>
