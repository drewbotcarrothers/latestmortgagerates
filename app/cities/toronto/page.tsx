        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
              ...
              <Link href="/tools#payment-calculator" className="block text-center px-4 py-2 bg-teal-600 text-white rounded-lg font-medium hover:bg-blue-700 transition">
                Calculate Payments
              </Link>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mt-6">
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/blog/closing-costs-canada" className="text-teal-600 hover:underline">Toronto Closing Costs Guide</Link></li>
                <li><Link href="/blog/best-mortgage-rates-toronto" className="text-teal-600 hover:underline">Toronto Rates Deep Dive</Link></li>
