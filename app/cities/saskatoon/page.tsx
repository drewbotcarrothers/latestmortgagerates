        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <nav className="text-sm text-slate-500 mb-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              ...
              <li className="text-slate-900 font-medium">Saskatoon</li>
            </ol>
          </nav>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-slate-900">Best Mortgage Rates in Saskatoon 2025</h1>
              <p className="text-slate-600 mt-2 text-lg">Fast-growing prairie city. No land transfer tax! Average home $380K.</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Current Saskatoon Mortgage Rates</h2>
              ...
              <div className="bg-slate-50 rounded-lg p-4"><p className="text-sm text-slate-700"><strong>Prairie Advantage:</strong> ~$380K average, no LTT. Fast-growing economy with university and ag-tech.</p></div>
            </section>

            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Saskatchewan Programs</h2>
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4"><h3 className="font-semibold text-slate-900">No Land Transfer Tax</h3><p className="text-slate-700">Save thousands in closing costs. Only small registration fee applies.</p></div>
                <div className="border-l-4 border-blue-500 pl-4"><h3 className="font-semibold text-slate-900">First-Time Home Buyers' Tax Credit</h3><p className="text-slate-700">Saskatchewan offers tax credits for first-time buyers.</p></div>
              </div>
            </section>

            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Saskatoon Market Factors</h2>
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4"><h3 className="font-semibold text-slate-900">University of Saskatchewan</h3><p className="text-slate-700">Research powerhouse driving innovation economy. Strong rental demand from students.</p></div>
                <div className="border-l-4 border-blue-500 pl-4"><h3 className="font-semibold text-slate-900">Agriculture Tech Hub</h3><p className="text-slate-700">Global ag-tech research center. Innovations in crop science and ag automation.</p></div>
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
              <h3 className="font-bold text-slate-900 mb-4">Why Saskatoon?</h3>
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">$380K average homes</span></li>
                <li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">Research university</span></li>
                <li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">Growing tech sector</span></li>
              </ul>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6 mt-6">
              <h3 className="font-bold text-slate-900 mb-4">Compare Cities</h3>
              <ul className="space-y-2 text-sm">
                <li><Link href="/cities/regina" className="text-teal-600 hover:underline">Regina Rates</Link></li>
            ...
            <div className="bg-teal-50 rounded-lg p-6 mt-6">
              <h3 className="font-bold text-slate-900 mb-2">Compare Saskatoon Rates</h3>
              <p className="text-slate-600 text-sm mb-4">See rates from Saskatchewan lenders.</p>
