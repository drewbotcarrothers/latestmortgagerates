...
<li className="text-slate-900 font-medium">Oshawa</li>
</ol>
</nav>
<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
<div>
<div className="inline-flex items-center gap-2 bg-teal-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium mb-3"><span>🚆 GTA Location, Durham Prices</span></div>
<h1 className="text-3xl md:text-4xl font-bold text-slate-900">Best Mortgage Rates in Oshawa 2025</h1>
<p className="text-slate-600 mt-2 text-lg">GTA with $500K savings! GO Train commuter hub. Find your rate.</p>
</div>
</div>
</div>
</header>
...
<h2 className="text-2xl font-bold text-slate-900 mb-4">Current Oshawa Mortgage Rates</h2>
...
<div className="bg-slate-50 rounded-lg p-4"><p className="text-sm text-slate-700"><strong>GTA Value:</strong> ~$720K average. Save $480K vs Toronto with GO Train access!</p></div>
</section>
...
<div className="border-l-4 border-blue-500 pl-4"><h3 className="font-semibold text-slate-900">Durham First-Time Buyer Incentives</h3><p className="text-slate-700">Regional programs support GTA-area first-time buyers.</p></div>
</div>
</section>

<section className="bg-white rounded-lg shadow-md p-6">
<h2 className="text-2xl font-bold text-slate-900 mb-4">Oshawa Market Factors</h2>
<div className="space-y-4">
<div className="border-l-4 border-green-500 pl-4"><h3 className="font-semibold text-slate-900">Lakeshore GO Train</h3><p className="text-slate-700">Regular service to Toronto Union Station. Oshawa GO is eastern terminus.</p></div>
<div className="border-l-4 border-blue-500 pl-4"><h3 className="font-semibold text-slate-900">Ontario Tech University</h3><p className="text-slate-700">UOIT brings 10,000+ students. New research programs attract talent.</p></div>
<div className="border-l-4 border-purple-500 pl-4"><h3 className="font-semibold text-slate-900">GM Heritage</h3><p className="text-slate-700">Skilled trades workforce from auto industry history supports new manufacturing.</p></div>
</div>
</section>
</div>
...
<h3 className="font-bold text-slate-900 mb-4">Why Oshawa?</h3>
<ul className="space-y-3 text-sm">
<li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">Official GTA member</span></li>
<li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">$480K savings vs Toronto</span></li>
<li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">GO Train commuter access</span></li>
<li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">UOIT university town</span></li>
</ul>
</div>
...
<li><Link href="/cities/barrie" className="text-teal-600 hover:underline">Barrie Rates</Link></li>
<li><Link href="/cities/hamilton" className="text-teal-600 hover:underline">Hamilton Rates</Link></li>
</ul>
</div>

<div className="bg-teal-50 rounded-lg p-6 mt-6"><h3 className="font-bold text-slate-900 mb-2">Compare Oshawa Rates</h3><p className="text-slate-600 text-sm mb-4">See rates from Durham Region lenders.</p><Link href="/" className="block text-center px-4 py-2 bg-teal-600 text-white rounded-lg font-medium hover:bg-blue-700 transition">View Rates</Link></div>
