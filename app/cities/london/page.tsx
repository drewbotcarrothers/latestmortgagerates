        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <nav className="text-sm text-slate-500 mb-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              ...
              <li className="text-slate-900 font-medium">London</li>
            </ol>
          </nav>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-slate-900">Best Mortgage Rates in London 2025</h1>
              <p className="text-slate-600 mt-2 text-lg">Affordable housing, top universities, strong healthcare sector. Perfect for families.</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Current London Mortgage Rates</h2>
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-slate-700">Up to $4,000 rebate. Full coverage on homes to $368K.</p>
                </div>                
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-slate-900">Affordable Entry</h3>
                  <p className="text-slate-700">$680K average makes first homes accessible. Many starter homes under $600K.</p>
                </div>
              </div>
            </section>

            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">London Market Factors</h2>
              
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-semibold text-slate-900">Education Hub</h3>
                  <p className="text-slate-700">Western University + Fanshawe College = 50,000+ students. 
                  Constant rental demand near campus.</p>
                </div>
                
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-slate-900">Healthcare Anchor</h3>
                  <p className="text-slate-700">London Health Sciences Centre and 5+ hospitals. 
                ...
                <div className="border-l-4 border-purple-500 pl-4">
                  ...
                  <p className="text-slate-700">Robarts Research Institute and medical research drive innovation 
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
              <h3 className="font-bold text-slate-900 mb-4">Why London?</h3>
              
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">Affordable family homes</span></li>
                <li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">Strong student rental market</span></li>
                <li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">Major healthcare employers</span></li>
                <li className="flex items-start gap-2"><span className="text-emerald-500">✓</span><span className="text-slate-700">Green space everywhere</span></li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mt-6">
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/cities/kitchener" className="text-teal-600 hover:underline">Kitchener Rates</Link></li>
                <li><Link href="/cities/hamilton" className="text-teal-600 hover:underline">Hamilton Rates</Link></li>
                <li><Link href="/cities/windsor" className="text-teal-600 hover:underline">Windsor Rates</Link></li>
              </ul>
            </div>

            <div className="bg-teal-50 rounded-lg p-6 mt-6">
              <h3 className="font-bold text-slate-900 mb-2">Compare London Rates</h3>
              <p className="text-slate-600 text-sm mb-4">See rates from London mortgage brokers.</p>
          ...
          <CityLendersSidebar cityName="London" />
          </aside>
        </div>
      </div>
    </main>
