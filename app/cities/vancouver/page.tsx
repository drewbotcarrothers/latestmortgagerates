    ...
    <main className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <nav className="text-sm text-slate-500 mb-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2">
              ...
              <li className="text-slate-900 font-medium">Vancouver</li>
            </ol>
          </nav>
          
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-slate-900">Best Mortgage Rates in Vancouver 2025</h1>
              <p className="text-slate-600 mt-2 text-lg">Compare rates for Vancouver and the Greater Vancouver Area</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Current Vancouver Mortgage Rates</h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-teal-50 rounded-lg p-4">
                  <p className="text-sm text-slate-600">5-Year Fixed Rate</p>
                  <p className="text-3xl font-bold text-teal-600">4.14%</p>
                  <p className="text-sm text-slate-500">Starting from</p>
                </div>
                <div className="bg-emerald-50 rounded-lg p-4">
                  <p className="text-sm text-slate-600">5-Year Variable Rate</p>
                  <p className="text-3xl font-bold text-emerald-600">3.80%</p>
                  <p className="text-sm text-slate-500">Starting from</p>
                </div>
              </div>
              
              <p className="text-slate-600 mb-6">Vancouver lenders often offer slightly lower rates than the national average due to competitive market conditions.</p>
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Vancouver Housing Market Overview</h2>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-slate-50 p-4 rounded-lg">
                  ...
                  <p className="text-xl font-bold text-slate-900">$2,100,000</p>
                </div>
                <div className="bg-slate-50 p-4 rounded-lg">
                ...
                <div className="bg-slate-50 p-4 rounded-lg">
                  ...
                  <p className="text-xl font-bold text-slate-900">$580,000</p>
                </div>
              </div>
              
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">BC Property Transfer Tax</h3>
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-slate-900 mb-4">Vancouver Market Factors</h2>
              
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-semibold text-slate-900">Foreign Buyer Ban</h3>
                  <p className="text-slate-700">Non-Canadians cannot purchase residential property for 2+ years, affecting demand.</p>
                </div>
                
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-slate-900">Speculation Tax</h3>
                  <p className="text-slate-700">The BC Speculation and Vacancy Tax applies to certain areas for properties not occupied as primary residences.</p>
                </div>
                ...
                <div className="border-l-4 border-orange-500 pl-4">
                  <h3 className="font-semibold text-slate-900">Environmental Factors</h3>
                  <p className="text-slate-700">Some lenders offer green mortgage incentives for energy-efficient homes.</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <aside className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
              <h3 className="font-bold text-slate-900 mb-4">Vancouver Mortgage Insights</h3>
              
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500">✓</span>
                  <span className="text-slate-700">Credit unions often have best rates</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500">✓</span>
                  <span className="text-slate-700">30-year amortization common for 20%+ down</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-500">✓</span>
                  <span className="text-slate-700">First-time buyer exemptions available</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mt-6">
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/blog/closing-costs-canada" className="text-teal-600 hover:underline">BC Closing Costs</Link></li>
                <li><Link href="/blog/best-mortgage-rates-vancouver" className="text-teal-600 hover:underline">Vancouver Rates Guide</Link></li>
            ...
            <div className="bg-teal-50 rounded-lg p-6 mt-6">
              <h3 className="font-bold text-slate-900 mb-2">Compare Vancouver Rates</h3>
              <p className="text-slate-600 text-sm mb-4">See rates from credit unions, banks, and online lenders.</p>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="font-bold text-slate-900 mb-2">Share Vancouver Mortgage Rates</h3>
