    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 md:p-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">⚡ Customize Your Widget</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Number of rates</label>
                <select 
                  id="limit-select"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                  defaultValue="3"
            ...
            <div>
              <p className="text-xs text-gray-500 uppercase tracking-wide mb-3">Preview</p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-4">Copy and paste this into your website HTML:</p>
        ...
        {/* Benefits */}
        <div className="bg-white rounded-xl shadow-sm p-6 md:p-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">✨ Why Add This Widget?</h2>
        ...
        {/* Perfect For */}
        <div className="bg-white rounded-xl shadow-sm p-6 md:p-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">📍 Perfect For</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { name: 'Mortgage Brokers', desc: 'Show competitive rates alongside your offerings', color: 'bg-blue-50' },
              { name: 'Real Estate Agents', desc: 'Help buyers understand financing costs', color: 'bg-green-50' },
